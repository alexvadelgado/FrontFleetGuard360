      ...
      <header className="bg-white border-b border-gray-200 shadow-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="bg:flex bg:justify-between">
            <h1 className="text-xl font-bold text-primary">Portal de Administrador</h1>
            <p className="text-sm text-gray-600 lg:hidden">
              Hola, Admin {role} <span className="font-medium">{userName}</span>
            </p>
          </div>
          <div className="flex flex-row items-center gap-4">
            <p className="text-sm text-gray-600 hidden lg:block">
              Hola, Admin <span className="font-medium">{userName}</span>
            </p>
            <Button
              variant="outline"
